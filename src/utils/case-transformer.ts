...
export class CaseTransformer {
   ...
   * If x is `string`, returns new CaseTransformer with split camelCased string for chaining.
   */
   ...
   * If x is `string`, returns new CaseTransformer with split dot.cased string for chaining.
   */
   ...
   * If x is `string`, returns new CaseTransformer with split colon:cased string for chaining.
   */
   ...
   * If x is `string`, returns new CaseTransformer with split kebab-cased string for chaining.
   */
   ...
   * If x is `string`, returns new CaseTransformer with split snake_cased string for chaining.
   */
   ...
   * If x is `string`, returns new CaseTransformer with split PascalCased string for chaining.
   */
